...
impl LoopVisitor {
    ...
    fn visit_while_expr(
                    ...
                    match inner_pair.as_rule() {
                        Rule::comma_delimited_exprs_for_verus_clauses => {
                            ...
                            for sub_expr in sub_expressions {
                                ...
                                let invariant_to_assertion_str = format!("assert({});", sub_expr.as_str()); 
        ...
        if let (Some(ref condition), Some(ref fn_block_expr)) = (condition, fn_block_expr) {
            ...
            let full_block = Self::add_loop_inv_as_assertions(fn_block_expr.as_str(), invariant_to_assertions);
